...
use WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository;

class ReaderStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(ReaderStateRepository::class);
    }
    ...
    /**
     * A basic functional test on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testReaderStateRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Give
        factory(Reader::class)->create();
        factory(ReaderState::class)->create();
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(ReaderStateLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Reader::class)->create();
        factory(ReaderState::class)->create(['is_enabled' => 1]);
        factory(ReaderState::class, 3)->create();
    ...
    /**
     * Unit test about Query List on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository
     *
    ...
    public function testQueryList()
    {
        ...
        // Give
        factory(Reader::class)->create();
        factory(ReaderState::class, 4)->create();
    ...
    /**
     * Unit test about FormTrait on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(ReaderState::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(ReaderState::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(ReaderState::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on ReaderStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceRFID\Models\Repositories\ReaderStateRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Reader::class)->create();
        factory(ReaderState::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(ReaderState::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
