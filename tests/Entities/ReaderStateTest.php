...
class ReaderStateTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    /**
     * A basic functional test on ReaderState.
     *
     * For WalkerChiu\DeviceRFID\Models\Entities\ReaderState
     * 
     * @return void
     */
    public function testReaderState()
    {
        ...
        $record_1 = factory(ReaderState::class)->create();
        $record_2 = factory(ReaderState::class)->create();
        $record_3 = factory(ReaderState::class)->create(['is_enabled' => 1]);

        // Get records after creation
            // When
            $records = ReaderState::all();
            // Then
        ...
        // Return Lang class
            ...
            $class = $record_2->lang();
            // Then
            $this->assertEquals($class, ReaderStateLang::class);

        // Scope query on enabled records
            // When
            $records = ReaderState::ofEnabled()
                                  ->get();
            // Then
        ...
        // Scope query on disabled records
            // When
            $records = ReaderState::ofDisabled()
                                  ->get();
            // Then
            $this->assertCount(2, $records);
    }
